...
- [#160](https://github.com/decentralized-identity/did-jwt-vc/pull/160) [`f7f7c15`](https://github.com/decentralized-identity/did-jwt-vc/commit/f7f7c15e62404e163f09abb6d9d2a28a4094e19f) Thanks [@mirceanis](https://github.com/mirceanis)! - BREAKING CHANGE: the package exports map has changed to new paths. The functionality of the library is unchanged.

  Along with this change, the package now uses plain `tsc` to compile instead of microbundle, and now we are targeting ES2024.
